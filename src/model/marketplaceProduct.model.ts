...
interface IMarketplaceProduct extends Document {
...
const MarketplaceProductModel = model<IMarketplaceProduct>('MarketplaceProducts', productSchema);

export { MarketplaceProductModel, IMarketplaceProduct };
