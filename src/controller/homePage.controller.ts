...
export const createHomePage = catchAsync(async (req: Request, res, next) => {
...
export const getHomePageById = catchAsync(async (req, res, next) => {
...
export const updateHomePage = catchAsync(async (req: Request, res, next) => {
  const { decoded } = req.body;
  const tenantId = decoded.id;
